...
from figconvnet.components.encodings import SinusoidalEncoding
from figconvnet.components.mlp import MLPBlock
from figconvnet.components.reductions import (
    REDUCTION_TYPES,
    row_reduction,
)
from figconvnet.geometries import PointFeatures
from figconvnet.neighbor_ops import (
